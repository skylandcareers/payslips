...
const MouriLetterheadGenerator = () => {
  ...
  const PageHeader = () => (
    <div className="w-full relative pt-2 print:pt-6">
      ...
      <div className="flex justify-between items-end pb-4 mb-6 border-b border-gray-200 w-full bg-white mt-2 print:mt-6">
        <div>
          <img src="https://www.mouritech.com/wp-content/uploads/2021/10/MT-Home-Logo-1-1.png" alt="MOURI Tech" className="h-14 w-auto object-contain mb-1" />
        </div>
        <div className="text-right text-gray-500 text-[10px] leading-[1.5] font-sans">
          ...
          <p>D1 IT Park Hill #2, Rushikonda</p>
          <p>Madhurawada, Visakhapatnam, 530003, AP</p>
          <p className="mt-1"><span className="text-gray-400">P:</span> +91 891 681 4100 &nbsp;|&nbsp; <span className="text-gray-400">E:</span> info@mouritech.com</p>
        </div>
      </div>
    </div>
  );
  ...
  const PageFooter = () => (
    <div className="w-full relative border-t border-gray-200 bg-white mt-8 pt-4 pb-10 md:pb-14 print:pb-4">
      <div className="flex justify-between items-center font-sans text-[9px] text-gray-400">
              ...
              <tbody className="print-body">
                <tr>
                  <td className="h-full align-top">
                    {/* Content padding */}
                    <div className="px-10 md:px-14 py-8 font-sans text-[11px] text-gray-700 leading-[1.6]">
                      
                      <div className="flex justify-between items-start mb-10 text-gray-900">
                        <div>
                      ...
                      {formData.subject && (
                        <div className="mb-8">
                          <p className="font-bold text-gray-900 underline underline-offset-4">Subject: {formData.subject}</p>
                        </div>
                      )}

                      <div className="mb-6">
                        <p className="text-gray-900">{formData.salutation}</p>
                      </div>

                      <div className="space-y-4 text-justify text-gray-900">
                        {formData.bodyText.split('\\n').map((paragraph, idx) => (
                          <p key={idx} className="min-h-[1rem]">{paragraph}</p>
                        ))}
                      </div>

                      <div className="mt-16 pt-4 mb-10">
                        <p className="font-bold text-gray-900 mb-12">For MOURI Tech Limited</p>
                        <p className="font-bold text-gray-900 border-t-2 border-gray-200 pt-3 w-56">{formData.signatoryName}</p>
