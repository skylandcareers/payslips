            ...
            <div className="grid gap-4 pt-4 border-t border-white/10">
              ...
              <div className="bg-white/5 p-3 rounded-md border border-white/10 mb-4 space-y-3">
                ...
                <div className="pt-3 border-t border-white/10 mt-2">
                  <label className="block text-[10px] mb-1 text-[#E93D44] font-bold uppercase tracking-wider">Reverse Calc from Take-Home</label>
                  <div className="flex gap-2">
                    <input type="text" id="autoTakeHome" placeholder="e.g. 2,23,000" className="w-full bg-black/50 border border-[#E93D44]/30 rounded px-3 py-2 text-sm focus:border-[#E93D44] outline-none placeholder:text-[#E93D44]/30" />
                    <button type="button" onClick={() => {
        ...
        <div className={`print-container flex-1 overflow-y-auto bg-gray-200 p-6 rounded-xl md:flex flex-col gap-10 items-center relative print:block print:bg-transparent print:rounded-none print:p-0 print:m-0 print:overflow-visible ${activeTab === "preview" ? "flex" : "hidden"}`}>
          ...
          <div className="page-container w-full max-w-[210mm] min-h-[297mm] bg-white text-black shadow-2xl p-10 md:p-14 relative flex flex-col print:shadow-none print:w-full print:max-w-none print:h-auto font-sans overflow-hidden">
            ...
            <div className="relative z-10 flex flex-col h-full flex-1">
              ...
              <div className="flex items-center justify-between border-b-[1.5px] border-[#E93D44] pb-4 mb-6 pt-2 bg-white">
                <div className="flex items-center gap-4">
                  <img src="https://media.licdn.com/dms/image/v2/D560BAQGREzSyNC8Gtw/company-logo_200_200/company-logo_200_200/0/1687330866404/aviso_inc_logo?e=2147483647&v=beta&t=8-c6FAeLmXM5IIbukECZ4W6vgIhc7bdaEYOWfOaMWYw" alt="aviso logo" className="h-12 w-12 object-contain" />
                  <div>
                    <h1 className="text-[18px] font-extrabold text-[#E93D44] uppercase tracking-wider">Aviso Software India LLP</h1>
                    <p className="text-[10px] text-gray-600 mt-1">LLPIN: AAL-4581 | 4th Floor, Block B, Purva Summit, Whitefield Road, Hitec City, Hyderabad - 500081</p>
                  </div>
                </div>
              </div>
