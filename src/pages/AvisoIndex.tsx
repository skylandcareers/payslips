    ...
    <div className="min-h-screen bg-black text-white relative overflow-hidden flex flex-col justify-center items-center">
      ...
      <div className="relative z-10 w-full max-w-6xl px-6 py-12 flex flex-col items-center">
        ...
        <div className="absolute top-6 left-6 z-20">
          <Link to="/" className="px-4 py-2 bg-white/10 hover:bg-white/20 border border-white/20 rounded-full text-sm font-medium transition-all duration-300 flex items-center gap-2">
            <span className="text-primary">←</span> Back to Portal
          </Link>
        </div>
